...
{
  internal class OwinIISHost : IOwinSelfHost
  {
    private readonly IWireMockMiddlewareOptions _options;
    private readonly CancellationTokenSource _cts = new CancellationTokenSource();
    private readonly IWireMockLogger _logger;
    private readonly IAppBuilder m_appBuilder;

    private Exception _runningException;

    public OwinIISHost([NotNull] IWireMockMiddlewareOptions options, [NotNull] HostUrlOptions urlOptions, [NotNull] IAppBuilder p_appBuilder)
    {
